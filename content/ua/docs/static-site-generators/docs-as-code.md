...
**Запуск тестів документації.** Як і розробники, техрайтери тестують документацію на відповідність певним вимогам: відсутність неробочих посилань, лінтер Vale з правилами перевірки на відповідність вимогам стайлгайдів Майкрософт, Гугл і власних стайлгайдів. Про це я писав у [попередній статті](https://dou.ua/forums/topic/32982/).
...
2. Установіть Node.js, якщо версія не відображається.
